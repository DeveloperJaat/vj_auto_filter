...
API_ID = int(environ.get('API_ID', '13985209'))
API_HASH = environ.get('API_HASH', '9ecc14b98a6c7bfbc445f3b425a56e21')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002523031406') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nitishjaat3363:bot@cluster0.p5bhlbl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'MandaliWala') # owner username without @
...
SESSION_STRING = environ.get('SESSION_STRING', '-1002098128989') # PYROGRAM V2 Session 
